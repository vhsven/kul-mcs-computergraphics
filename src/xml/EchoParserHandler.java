...
public class EchoParserHandler implements ParserHandler
{
    ...
    public void startSphere(Point3f position, float radius, String name) throws ParseException
    {
        indent++;
        for (int i = 0; i < indent; i++) System.out.print(indentString);
        System.out.println(
    ...
    public void startBunny(float size, String name) throws ParseException
    {
        indent++;
        for (int i = 0; i < indent; i++) System.out.print(indentString);
        System.out.println(
    ...
    public void endBunny() throws ParseException
    {
        for (int i = 0; i < indent; i++) System.out.print(indentString);
    ...
    public void startDisk(float radius, Vector3f normal, String name) throws ParseException
    {
        indent++;
        for (int i = 0; i < indent; i++) System.out.print(indentString);
        System.out.println(
    ...
    public void endDisk() throws ParseException
    {
        for (int i = 0; i < indent; i++) System.out.print(indentString);
    ...
    public void startObject(String src, float size, String name) throws ParseException
    {
        indent++;
        for (int i = 0; i < indent; i++) System.out.print(indentString);
        System.out.println(
    ...
    public void startCornell(String name) throws ParseException
    {
        indent++;
        for (int i = 0; i < indent; i++) System.out.print(indentString);
        System.out.println(
    ...
    public void endCornell() throws ParseException
    {
        for (int i = 0; i < indent; i++) System.out.print(indentString);
        System.out.println("</CornellBox>");
        indent--;
    }
    ...
    public void startBumpTextures() throws ParseException
    {
        indent++;
        for (int i = 0; i < indent; i++) System.out.print(indentString);
        System.out.println("<BumpTextures>");
    }

    public void endBumpTextures() throws ParseException
    {
        for (int i = 0; i < indent; i++) System.out.print(indentString);
        System.out.println("</BumpTextures>");
        indent--;
    ...
    public void startBumpTexture(String src, String name) throws ParseException
    {
        indent++;
        for (int i = 0; i < indent; i++) System.out.print(indentString);
        System.out.println(
    ...
    public void endBumpTexture() throws ParseException
    {
        for (int i = 0; i < indent; i++) System.out.print(indentString);
        System.out.println("</BumpTexture>");
        indent--;
    }
    ...
    public void startShape(String geometryName, String materialName, String textureName, String bumpTextureName) throws Exception
    {
        ...
        System.out.println(
            ...
            + (bumpTextureName == null ? "" : " bumptexture=\"" + bumpTextureName + "\"")
            + ">"
        );
    }
